...
class SiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'foto.mimes' => 'foto hanya bisa di isi menggunakan extaion tertentu'
        ]);
        ...
        siswa::create($data);
        return redirect('siswa')->with('sukses', 'BERHASIL MEMASUKKAN DATA');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($request->hasFile('foto')) {
            $request->validate([
                ...
                'foto.mimes' => 'foto hanya bisa di isi menggunakan extaion tertentu jpeg,jpg,png,gif ' 
            ]);
            $foto_file = $request->file('foto');
            $foto_ekstensi =$foto_file->extension();
            $foto_nama = date('ymdhis') . "." . $foto_ekstensi;
        ...
        return redirect('/siswa')->with('sukses','berhasil melakukan update data');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/siswa')->with('sukses','berhasil melakukan hapus data');
    }
}
